...
def data_repair():
    ...
    # Soft-delete ALL existing ledger entries to allow for a complete reset
    ...
    db.session.commit()
    return jsonify({"entries_voided": entries_voided, "message": "All financial records have been reset successfully"}), 200
